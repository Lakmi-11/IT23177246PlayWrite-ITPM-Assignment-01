...
test('Pos_Fun_0016 - Convert sentence containing unit of measurement', async ({ page }) => {
  ...
  // 4️⃣ Type sentence with unit of measurement slowly
  await page.keyboard.type(
    'oyaata haal 10KG k geenna salli dhennadha?',
    { delay: 150 }
  );
  ...
  await page.screenshot({ path: 'screenshots/pos-fun-0016.png' });
});
