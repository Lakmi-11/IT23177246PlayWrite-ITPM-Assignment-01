...
test('Pos_Fun_0013 - Convert sentence with imperative (command) forms', async ({ page }) => {
  ...
  // 4️⃣ Type imperative sentences slowly
  await page.keyboard.type(
    'vahaama enna. mee upadhes pilipadhinna. issarahata yanna. aapasu haerenna epaa.',
    { delay: 150 }
  );
  ...
  await page.screenshot({ path: 'screenshots/pos-fun-0013.png' });
});
