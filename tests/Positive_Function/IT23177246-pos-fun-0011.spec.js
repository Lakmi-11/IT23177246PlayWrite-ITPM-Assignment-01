...
test('Pos_Fun_0011 - Convert sentence containing place and common English words', async ({ page }) => {
  ...
  // 4️⃣ Type Singlish sentence (places + English words)
  await page.keyboard.type(
    'adha School naee. ee venuvata Zoom ekak thiyenavaa.',
    { delay: 150 }
  );
  ...
  await page.screenshot({ path: 'screenshots/pos-fun-0011.png' });
});
