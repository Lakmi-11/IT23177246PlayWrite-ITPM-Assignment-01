...
test('Pos_Fun_0015 - Convert sentence with positive forms and assurance', async ({ page }) => {
  ...
  // 4️⃣ Type positive-form sentences slowly
  await page.keyboard.type(
    'mama kivvoth dheyak karanavamayi. heta anivaaryenma enna.',
    { delay: 150 }
  );
  ...
  await page.screenshot({ path: 'screenshots/pos-fun-0015.png' });
});
